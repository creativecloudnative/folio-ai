...
const FEATURES = [
  ...
  },
  {
    ...
    title: 'Job Tracker',
    description:
      'Track every application end-to-end — timeline events, interview records, and supporting evidence all in one place. Generate tailored resumes from job descriptions using your own portfolio as source material. The studio agent can log timeline entries on demand.',
  },
]
    ...
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <footer className="border-t border-zinc-800/60 py-8 px-6">
        <div className="mx-auto max-w-6xl flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-zinc-600">
          <span>
            folio-ai — open source, MIT licensed
